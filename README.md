...
## Modifications within this Fork
  - Only one scan cycle
  - Modified scanmethod. If you want to go back to the original method comment line 501 and uncomment line 504 in ~/pialert/back/pialert.py
  ...
  - "pialert-cli" that helps to configure login and password
