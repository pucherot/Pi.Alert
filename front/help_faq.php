...
$help_faq_toptemp = '
        <div class="panel panel-default faqhelp_bgcolor">
          <div class="panel-heading faqhelp_bgcolor">
      ...
      <h4><?php echo $pia_lang['HelpFAQ_Cat_General']; ?></h4>
       ...
       <?php echo $help_faq_toptemp; ?>
          ...
          <div id="collapse100" class="panel-collapse collapse" style="font-size: 16px;">
            <div class="panel-body faqhelp_bgcolor"><?php echo $pia_lang['HelpFAQ_Cat_General_100_text_a']; ?>
        ...
        <?php echo $help_faq_toptemp; ?>
          ...
          <div id="collapse101" class="panel-collapse collapse" style="font-size: 16px;">
            <div class="panel-body faqhelp_bgcolor">
