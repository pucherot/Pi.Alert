...
function createnetworktab($pia_func_netdevid, $pia_func_netdevname, $pia_func_netdevtyp, $pia_func_netdevport, $activetab) {
	...
	if (substr($pia_func_netdevtyp, 2) == 'WLAN') {
		echo '<i class="bi bi-wifi" style="font-size: 16px; position: relative; top: 1px;"></i>';} elseif (substr($pia_func_netdevtyp, 2) == 'Powerline') {
		echo '<i class="bi bi-plug-fill" style="font-size: 16px; position: relative; top: 2px;"></i>';} elseif (substr($pia_func_netdevtyp, 2) == 'Router') {
		echo '<i class="bi bi-router-fill" style="font-size: 16px; position: relative; top: 2px;"></i>';} elseif (substr($pia_func_netdevtyp, 2) == 'Switch') {
		echo '<i class="bi bi-ethernet" style="font-size: 16px; position: relative; top: 2px;"></i>';} elseif (substr($pia_func_netdevtyp, 2) == 'Internet') {
		echo '<i class="bi bi-globe" style="font-size: 16px; position: relative; top: 2px;"></i>';} else {echo substr($pia_func_netdevtyp, 2);}
