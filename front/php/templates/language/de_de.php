...
$pia_lang['Maintenance_Tools_Logviewer_Scan'] = 'Scan Log';
$pia_lang['Maintenance_Tools_Logviewer_Scan_empty'] = 'Es wird vermutlich gerade Scan ausgeführt';
$pia_lang['Maintenance_Tools_Logviewer_IPLog'] = '"Internet IP"-Log';
$pia_lang['Maintenance_Tools_Logviewer_IPLog_empty'] = 'Kein Log verfügbar';
$pia_lang['Maintenance_Tools_Logviewer_Vendor'] = '"Vendor Update"-Log';
...
$pia_lang['Maintenance_Tool_del_unknowndev_text'] = 'Machen Sie ein Backup, bevor Sie diese Funk&shy;tion nutzen. Der Vor&shy;gang kann ohne Back&shy;up nicht rück&shy;gängig gemacht werden. Alle Gräte mit dem Namen (unknown) werden aus der Daten&shy;bank ge&shy;löscht.';
