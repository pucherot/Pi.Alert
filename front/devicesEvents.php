          ...
          <a href="#" onclick="javascript: getEvents('all');">
            <div class="small-box bg-aqua">
              <div class="inner"> <h3 id="eventsAll"> -- </h3>
                <p class="infobox_label"><?=$pia_lang['Events_Shortcut_AllEvents'];?></p>
              </div>
          ...
          <a href="#" onclick="javascript: getEvents('sessions');">
            <div class="small-box bg-green">
              <div class="inner"> <h3 id="eventsSessions"> -- </h3>
                <p class="infobox_label"><?=$pia_lang['Events_Shortcut_Sessions'];?></p>
              </div>
          ...
          <a href="#" onclick="javascript: getEvents('missing');">
            <div  class="small-box bg-yellow">
              <div class="inner"> <h3 id="eventsMissing"> -- </h3>
                <p class="infobox_label"><?=$pia_lang['Events_Shortcut_MissSessions'];?></p>
              </div>
          ...
          <a href="#" onclick="javascript: getEvents('voided');">
            <div  class="small-box bg-yellow">
              <div class="inner"> <h3 id="eventsVoided"> -- </h3>
                <p class="infobox_label"><?=$pia_lang['Events_Shortcut_VoidSessions'];?></p>
              </div>
          ...
          <a href="#" onclick="javascript: getEvents('down');">
            <div  class="small-box bg-red">
              <div class="inner"> <h3 id="eventsDown"> -- </h3>
                <p class="infobox_label"><?=$pia_lang['Events_Shortcut_DownAlerts'];?></p>
              </div>
          ...
          <div id="tableEventsBox" class="box">
            ...
            <div class="box-body table-responsive">
              <table id="tableEvents" class="table table-bordered table-hover table-striped ">
                <thead>
                <tr>
                  <th><?=$pia_lang['Events_TableHead_Order'];?></th>
                  <th><?=$pia_lang['Events_TableHead_Device'];?></th>
                  <th><?=$pia_lang['Events_TableHead_Owner'];?></th>
                  <th><?=$pia_lang['Events_TableHead_Date'];?></th>
                  <th><?=$pia_lang['Events_TableHead_EventType'];?></th>
                  <th><?=$pia_lang['Events_TableHead_Connection'];?></th>
                  <th><?=$pia_lang['Events_TableHead_Disconnection'];?></th>
                  <th><?=$pia_lang['Events_TableHead_Duration'];?></th>
                  <th><?=$pia_lang['Events_TableHead_DurationOrder'];?></th>
                  <th><?=$pia_lang['Events_TableHead_IP'];?></th>
                  <th><?=$pia_lang['Events_TableHead_IPOrder'];?></th>
...
function getEvents (p_eventsType) {
  ...
  switch (eventsType) {
    case 'all':       tableTitle = '<?=$pia_lang['Events_Shortcut_AllEvents'];?>';      color = 'aqua';    sesionCols = false;  break;
    case 'sessions':  tableTitle = '<?=$pia_lang['Events_Shortcut_Sessions'];?>';       color = 'green';   sesionCols = true;   break;
    case 'missing':   tableTitle = '<?=$pia_lang['Events_Shortcut_MissSessions'];?>';   color = 'yellow';  sesionCols = true;   break;
    case 'voided':    tableTitle = '<?=$pia_lang['Events_Shortcut_VoidSessions'];?>';   color = 'yellow';  sesionCols = false;  break;
    case 'new':       tableTitle = '<?=$pia_lang['Events_Shortcut_NewDevices'];?>';     color = 'yellow';  sesionCols = false;  break;
    case 'down':      tableTitle = '<?=$pia_lang['Events_Shortcut_DownAlerts'];?>';     color = 'red';     sesionCols = false;  break;
    default:          tableTitle = '<?=$pia_lang['Events_Shortcut_Events'];?>';         boxClass = '';     sesionCols = false;  break;
  }
